...
if [ "$MIRAGE_BACKEND" = "xen" \
    ...
    echo "Host rowlandwatkins github.com"   >> ~/.ssh/config
    ...
    git config --global user.email "rowland.watkins@gmail.com"
    ...
    git clone git@rowlandwatkins:rowlandwatkins/mirage-repo
    cd mirage-repo
